								...
								<v-scroll-y-transition mode="out-in">
									...
									>
										...
										<v-layout
											...
											wrap
										>
											<v-flex tag="strong" xs5 text-right mr-3 mb-2>Company:</v-flex>
											<v-flex>{{ selected.company.name }}</v-flex>
											<v-flex tag="strong" xs5 text-right mr-3 mb-2>Website:</v-flex>
											<v-flex>
												<a :href="`//${selected.website}`" target="_blank">{{ selected.website }}</a>
											</v-flex>
											<v-flex tag="strong" xs5 text-right mr-3 mb-2>Phone:</v-flex>
