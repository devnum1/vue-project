<template>
	<div class="custom-flex">
		...
		<v-container grid-list-xl pt-0>
			<v-layout row wrap>
				<app-card :heading="$t('message.simple')" customClasses="mb-30" colClasses="xl12 lg12 md12 sm12 xs12">
					<v-row>
						<v-col
						  v-for="n in 3"
						  :key="n"
				...
				<app-card :heading="$t('message.height')" customClasses="mb-30" colClasses="xl12 lg12 md12 sm12 xs12">
				...
				<app-card :heading="$t('message.fixedRatio')" customClasses="mb-30" colClasses="xl12 lg12 md12 sm12 xs12">
				...
				<app-card :heading="$t('message.gradients')" customClasses="mb-30" colClasses="xl12 lg12 md12 sm12 xs12">
					<v-layout row wrap>
						<v-flex xs12 sm4>
