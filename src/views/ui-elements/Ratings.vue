<template>
	<div>
		...
		<v-container grid-list-xl pt-0>
			<v-layout row wrap>
				<app-card :heading="$t('message.default')" customClasses="mb-30" colClasses="xl6 lg6 md6 sm12 xs12">
					<div class="mb-5">
				...
				<app-card :heading="$t('message.sizeVariants')" customClasses="mb-30" colClasses="xl6 lg6 md6 sm12 xs12">
					<div class="mb-5">
